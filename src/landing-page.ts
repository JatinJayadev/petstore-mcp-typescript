...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": { "ENVIRONMENT": "YOUR_VALUE_HERE", "API_KEY": "YOUR_VALUE_HERE" },
  };
  const codexConfig = `[mcp_servers.Petstore]
url = "${o}/sse"
http_headers = { "environment" = "YOUR_ENVIRONMENT", "api-key" = "YOUR_API_KEY" }`;
...
<head>
    ...
    <title>petstormcp-cliente MCP</title>
    <meta name="description" content="Install petstormcp-cliente MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="petstormcp-cliente - MCP Server">
    <meta property="og:description" content="Install petstormcp-cliente MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="petstormcp-cliente - MCP Server">
    <meta property="twitter:description" content="Install petstormcp-cliente MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">petstormcp-cliente</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Petstore&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwZXRzdG9ybWNwLWNsaWVudGUiLCJzdGFydCIsIi0tZW52aXJvbm1lbnQiLCJwcm9kIiwiLS1hcGkta2V5IiwiIl19">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Petstore&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwZXRzdG9ybWNwLWNsaWVudGUiLCJzdGFydCIsIi0tZW52aXJvbm1lbnQiLCJwcm9kIiwiLS1hcGkta2V5IiwiIl19">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Petstore&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwZXRzdG9ybWNwLWNsaWVudGUiLCJzdGFydCIsIi0tZW52aXJvbm1lbnQiLCJwcm9kIiwiLS1hcGkta2V5IiwiIl19">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Petstore&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJwZXRzdG9ybWNwLWNsaWVudGUiLCJzdGFydCIsIi0tZW52aXJvbm1lbnQiLCJwcm9kIiwiLS1hcGkta2V5IiwiIl19">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add Petstore -- npx -y petstormcp-cliente start --environment prod --api-key </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add Petstore -- npx -y petstormcp-cliente start --environment prod --api-key </code>
        </div>
      </div>
    </div>
